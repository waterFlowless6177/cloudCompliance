...
public class BattleshipController {
    ...
    private int[] getShipsCounters() {
        ...
        System.out.println("Carrier = 5 "+ "Battleship = 4 "+ "Cruiser = 3 " + "Destroyer = 2 "+ "Submarine = 1");
    ...
    private int executeCurrentCommand(String[] atoms) {
        try {
            ...
            // Recovery ship mode
            var pointsToUpdate = currentUser.getCurrentSession().recoveryStrategy.getPointsToRecover();
            if (pointsToUpdate != null) {
                view.recoverShips(pointsToUpdate);
                // clear list
                currentUser.getCurrentSession().recoveryStrategy.clearPointsToRecover();
            }
